	...
	render() {
		...
		let jsAuth = (
				<div style={{padding: '13px 2em', color: 'white', backgroundColor: '#1E2224'}}>
					...
					<p><span className="keyword">let</span> api = kittn.authorize(<span className="str">'meowmeowmeow'</span>)</p>
				</div>
			);
		...
		return (
				<Row>								
					<Col className="hidden-xs" style={{backgroundColor: '#2E3336', color: 'white', position: 'fixed', left: '0', top: '0', height: '100vh'}} lg={2}>
